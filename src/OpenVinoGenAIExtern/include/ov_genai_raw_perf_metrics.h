 ...
 * @ingroup ov_genai_raw_perf_metrics_c_api
 * @param perf_metrics A pointer to the ov_genai_raw_perf_metrics_t instance.
 * @param num_generated_tokens A pointer to the variable that will hold the number of generated tokens.
 * @return Status code of the operation: OK(0) for success.
 */
OPENVINO_C_API(ov_status_e)
 ...
 * @ingroup ov_genai_raw_perf_metrics_c_api
 * @param perf_metrics A pointer to the ov_genai_raw_perf_metrics_t instance.
 * @param num_input_tokens A pointer to the variable that will hold the number of input tokens.
 * @return Status code of the operation: OK(0) for success.
 */
OPENVINO_C_API(ov_status_e)
